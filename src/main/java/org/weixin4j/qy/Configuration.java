...
public class Configuration {
    ...
    static void init() {
        ...
        //读取自定义配置
        String t4jProps = "weixin4j-qy.properties";
        ...
        if (!loaded) {
            System.out.println("weixin4j:没有加载到weixin4j-qy.properties属性文件!");
        }
    }
    ...
    public static String getCorpId() {
        return getProperty("weixin4j.corpid");
    }
     ...
     * @return 第三方用户唯一凭证
     */
    public static String getCorpTxlSecret() {
        return getProperty("weixin4j.corptxl.secret");
    }
